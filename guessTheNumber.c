...
void P2P() {
	...
	int Player1_Number;
	printf("Player 1 type in a number between 1 and 50: ");
	scanf("%d", &Player1_Number);
	printf("\n\n");

	printf("Player 2 has 10 guesses to get the right number.\n\n");
	printf("Begin guessing...");

	int Player2_GuessesLeft = 10;	
...
int main() {
	...
	printf("Player 1 will type in a number between 1 and 50,\nPlayer 2 will guess Player 1's number
	Player 2 has 10 guesses\n\n");
